...
export const SYMBOL_RENDERER_DEFINITIONS: SymbolRendererDefinition[] = [
  {
    ...
    supportedKinds: ['resistor', 'capacitor', 'inductor', 'voltage-source', 'current-source', 'ac-voltage-source', 'pulse-voltage-source', 'reference-source', 'battery-cell', 'battery-pack', 'battery-coin-cell', 'ldo-regulator', 'buck-regulator', 'boost-regulator', 'charge-pump', 'current-regulator', 'wire'],
    expectedPinCounts: [2],
    render: () => NO_SYMBOL
  },
  {
